...
function WomensWear() {
  ...
  // Fetch live products from DB and filter to women's category
  useEffect(() => {
    dispatch(fetchProductsFromAPI()).then(() => {
      dispatch(categoryFilter("women"));
    });
  ...
  return (
    <div className="collection-page animate-fade">
      ...
      <div className="collection-banner women-theme">
        <div className="collection-banner-text">
          <h1>Women's Haute Couture</h1>
          <p>Flowing gowns, structured coats, luxury leather goods, and premium accessories, curated for absolute distinction.</p>
        </div>
      </div>
      ...
      <style>{`
        ...
        .collection-banner.women-theme {
          background-image: linear-gradient(rgba(22, 0, 2, 0.7), rgba(22, 0, 2, 0.9)), url('https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&auto=format&fit=crop&q=80');
        }
